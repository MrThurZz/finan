      ...
      <div className="w-full max-w-sm">
        ...
        >
          ...
          <button
            ...
            className="w-full text-center text-xs text-slate-500 underline dark:text-slate-400"
          >
            Esqueci minha senha
          </button>
        </form>
        ...
        <p className="mt-4 text-center text-sm text-slate-500 dark:text-slate-400">
          Não tem conta?{' '}
          <Link to="/cadastro" className="font-medium text-emerald-600 dark:text-emerald-400">
            Cadastre-se
          </Link>
        </p>
      </div>
